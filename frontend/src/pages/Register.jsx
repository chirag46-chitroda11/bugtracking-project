  ...
  return (
    <div className="auth-wrapper">
      <style>{`
        ...
        .c1 { width: 350px; height: 350px; top: -120px; left: -120px; }
        .c2 { width: 200px; height: 200px; bottom: -60px; right: -60px; animation-delay: 3s; }
        .c3 { width: 280px; height: 280px; bottom: 80px; left: 80px; animation-delay: 6s; }
        @keyframes float { 50% { transform: translateY(-20px) scale(1.05); } }
        .toast-box { position: fixed; top: 20px; right: 20px; padding: 1rem 2rem; border-radius: 12px; color: #fff; font-weight: 700; z-index: 1000; transform: translateX(150%); transition: 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); box-shadow: 0 8px 20px rgba(0,0,0,0.15); }
        ...
        .field { width: 100%; padding: 0.9rem 1.2rem; border-radius: 15px; border: 1px solid rgba(0,0,0,0.05); background: #fff; margin-bottom: 1rem; outline: none; transition: 0.3s; box-sizing: border-box; font-family: inherit; font-size: 0.95rem; }
        .field:focus { border-color: #4f46e5; box-shadow: 0 0 0 4px rgba(79,70,229,0.1); }
        .btn-reg { width: 100%; padding: 1rem; background: #121212; color: #fff; border-radius: 15px; font-weight: 700; border: none; cursor: pointer; transition: 0.3s; font-size: 0.95rem; }
        .btn-reg:hover:not(:disabled) { background: #4f46e5; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(79,70,229,0.25); }
        .btn-reg:disabled { opacity: 0.6; cursor: not-allowed; }
        @media (max-width: 800px) { .signup-card { max-width: 90%; } .form-side { padding: 2.5rem; } }
      `}</style>
      ...
      <div className="signup-card">
        <div className="form-side">
          <div className="flex items-center gap-2 mb-8 cursor-pointer" onClick={() => navigate("/")}>
            ...
            <span className="font-extrabold text-lg tracking-tighter uppercase">FIXIFY<span className="text-indigo-600">.</span></span>
          </div>
